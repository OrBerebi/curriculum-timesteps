...
image_dir = "/gpfs0/bgu-br/users/berebio/GitHub/ambient-tweedie/datasets/ffhq_128/"
stats_output_path = os.path.join(image_dir, "ffhq128_stats.npz")
...
def compute_fid_stats(image_dir, output_path):
    ...
    fid.make_custom_stats(name="ffhq128", fdir=image_dir, num=None)
    stats_src_path = fid.get_folder("ffhq128")

    # Move the stats file to the desired output path
    stats_file = os.path.join(stats_src_path, "fid_stats_ffhq128.npz")
